...
client.on('ready', async () => {
  ...
  console.log(`Made by Sky#3399`)
  console.log(`Credits | Nebula | https://dsc.gg/mkdevelopers`)
...
> \`${prefix}setstaff\` - set staff roles`)
 ...
 value : "<:arrow:883908192638222357>Bot , you want to apply , partner ship or want to oder a custom bot then create a ticket "  
        },
